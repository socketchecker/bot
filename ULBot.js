...
(function () {
    ...
    var basicBot = {
      ...
      commandLiteral: "!",
      blacklists: {
        NSFW: "https://bb.githack.com/mmcoding/ul-bot/raw/b542b31907cd47be39a5c6d494e4cfd43eccfa5a/blacklists/NSFW.json",
        OP: "https://bb.githack.com/mmcoding/ul-bot/raw/b542b31907cd47be39a5c6d494e4cfd43eccfa5a/blacklists/OP.json",
        BANNED: "https://bb.githack.com/mmcoding/ul-bot/raw/b542b31907cd47be39a5c6d494e4cfd43eccfa5a/blacklists/BANNED.json"
            }
        },
        room: {
            name: null,
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        if (typeof basicBot.settings.discordLink === "string")
                            API.sendChat(subChat(basicBot.chat.discord, {link: basicBot.settings.discordLink}));
                    }
                }
            },
